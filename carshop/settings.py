...
STATIC_DIR_CARSHOP=os.path.join(os.path.join(BASE_DIR,'carshop'),'static')
...
SECRET_KEY = 'viivow#ug@gf6#f9y+65aog8tldr*@cngw^r#zhb@c0m8g0bc*'
...
STATIC_URL = '/static/'
STATICFILES_DIRS=[STATIC_DIR_APP,STATIC_DIR_CARSHOP,]
